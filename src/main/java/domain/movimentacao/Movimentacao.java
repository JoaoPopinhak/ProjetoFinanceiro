...
public class Movimentacao {
	...
	public Movimentacao(Long id, TipoMovimentacao tipoMovimentacao, BigDecimal valorMovimentacao, LocalDateTime dataHoraMovimentacao, Long IdContaMovimentacao, String descricao) {
		this.setId(id);
		...
		this.setContaMovimentacao(IdContaMovimentacao);
	...
	public void setContaMovimentacao(Long IdContaMovimentacao) {
